...
const AdminCharityApprovals = () => {
  ...
  return (
    <div className="p-6 mx-auto max-w-6xl">
      <h1 className="mb-6 text-2xl font-bold text-slate-800">Duyệt tổ chức từ thiện</h1>

      {/* Filters */}
      <form onSubmit={onSearch} className="flex flex-wrap gap-3 items-end mb-4">
        <div className="flex-1 min-w-[220px]">
          <label className="block mb-1 text-sm text-slate-600">Tìm kiếm</label>
          <input
            value={search}
        ...
        <div className="w-56">
          <label className="block mb-1 text-sm text-slate-600">Thành phố</label>
          <input
            value={city}
        ...
        <table className="min-w-full text-sm">
          <thead className="bg-slate-50 text-slate-600">
            <tr>
              ...
              <th className="p-3 text-left">Giấy phép</th>
                    ...
                    <div className="flex gap-2 justify-end items-center">
                      ...
                      <div className="flex gap-2 items-center">
                        <input
                          ...
                          className="px-2 py-1 w-40 text-xs rounded-lg border"
                        />
                        <Button
                          variant="danger"
                          size="sm"
      ...
      {selected && (
        <div className="flex fixed inset-0 z-50 justify-center items-center bg-black/40">
          <div className="relative p-6 w-full max-w-2xl bg-white rounded-2xl shadow-xl">
            <button
            ...
            <h3 className="mb-3 text-xl font-semibold text-slate-800">{selected.name}</h3>
            ...
            <div className="flex gap-2 justify-end items-center mt-6">
              ...
              <input
                ...
                onChange={(e) => setRejectReason(e.target.value)}
                placeholder="Lý do từ chối"
                className="px-2 py-1 w-48 text-sm rounded-lg border"
              />
